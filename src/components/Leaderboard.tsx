  ...
  return (
    <div className="leaderboard">
      ...
      <div className="search-bar">
        ...
        />
        {search && (
          <span className="result-count">找到 {totalCount} 筆結果</span>
        )}
      </div>
              ...
              <Fragment key={gi}>
                ...
                {group.rows.map((a, i) => {
                  ...
                  return (
                    <tr
                      key={`${gi}-${i}`}
                      className={isTop ? `top-${displayRank}` : ""}
                    >
                      <td className="col-rank">
                        <span
                          className={`rank-badge ${isTop ? `rank-${displayRank}` : ""}`}
                        >
                          {displayRank}
                        </span>
                      </td>
                      ...
                      <td className="col-split col-transition">
                        {a.transitionTime || "—"}
                      </td>
